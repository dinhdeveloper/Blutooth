...
public class MainActivity extends AppCompatActivity implements ZXingScannerView.ResultHandler{
    ...
    private RelativeLayout layout_scanbar_code;
    ...
    private ZXingScannerView mScannerView,view_scan;
    PackageManager pm;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mScancode = (Button)findViewById(R.id.scan_code);
        mListPairedDevicesBtn = (Button)findViewById(R.id.paired_btn);
        content_frame = (FrameLayout)findViewById(R.id.content_frame);
        layout_scanbar_code = (RelativeLayout) findViewById(R.id.layout_scanbar_code);
...
//            });
            ...
            mScancode.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    if (ContextCompat.checkSelfPermission(MainActivity.this, Manifest.permission.CAMERA)
                        ...
                        layout_scanbar_code.setVisibility(View.VISIBLE);
                        startScan();
                    }
                }
            });
    ...
    private void scancode(String resultCode ) {
